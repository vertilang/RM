...
std::vector<Object> TRTModule::operator()(const cv::Mat &img) 
{
    ...
    for (int i = 0; i<objects.size(); i++)
    {
        ...
        cv::line(img, cv::Point2f(objects[i].landmarks[0],objects[i].landmarks[1]), cv::Point2f(objects[i].landmarks[2],objects[i].landmarks[3]),cv::Scalar(0, 0, 255), 4, 8);
        cv::line(img, cv::Point2f(objects[i].landmarks[2],objects[i].landmarks[3]), cv::Point2f(objects[i].landmarks[4],objects[i].landmarks[5]),cv::Scalar(0, 0, 255), 4, 8);
        cv::line(img, cv::Point2f(objects[i].landmarks[4],objects[i].landmarks[5]), cv::Point2f(objects[i].landmarks[6],objects[i].landmarks[7]),cv::Scalar(0, 0, 255), 4, 8);
        cv::line(img, cv::Point2f(objects[i].landmarks[6],objects[i].landmarks[7]), cv::Point2f(objects[i].landmarks[0],objects[i].landmarks[1]),cv::Scalar(0, 0, 255), 4, 8);
